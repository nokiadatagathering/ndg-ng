...
var ResultList = function() {
    ...
    function showResultList(i) {
        ...
        $('#minimalist').append( '<thead>'
                               + '<tr>'
                               + '<th scope="col"></th>'
                               + '<th scope="col"><a href="#" id="executeSortByResultId"><!--<img id="sortBySurveyName" src="images/surveyName.jpg"></a>--><b>' + LOC_RESULTID + '</b></th>'
                               + '<th scope="col"><a href="#" id="executeSortByResultTitle"><!--<img id="sortByDatePublished" src="images/datePublished.jpg"></a>--><b>' + LOC_RESULTTITLE + '</b></th>'
                               + '<th scope="col"><a href="#" id="executeSortByDateSent"><!--<img id="sortByPublisher" src="images/publisher.jpg"></a>--><b>' + LOC_DATESENT + '</b></th>'
                               + '<th scope="col"><a href="#" id="executeSortByUser"><!--<img id="sortByResults" src="images/results.jpg"></a>--><b>' +LOC_USER + '</b></th>'
                               + '<th scope="col"><a href="#" id="executeSortByLocation"><!--<img id="sortByResults" src="images/results.jpg"></a>--><b>'+ LOC_LOCATION + '</b></th>'
                               + '</tr>'
                               + '</thead>'
