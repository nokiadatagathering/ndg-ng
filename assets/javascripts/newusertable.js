var NewUserTable = (function() {
    ...
    function showTable(position) {
        ...
        tableHtml = '<form id="newUserForm" method="post" action="userManager/addUser"><table class="newUserTableClass">'
                  ...
                  + '<td class="newUserTdClass"><input class="newUserInput" type="text" name="username" maxlength="15" title="' + LOC.get( 'LOC_USERNAME' ) + '" /></td>'
                  + '<td class="newUserTdClass"><input class="newUserInput" type="text" name="firstName" maxlength="20" title="' + LOC.get( 'LOC_FIRST_NAME' ) + '" /></td>'
                  ...
                  + '<tr class="newUserTrClass">'
                  + '<td class="newUserTdClass">'
                  +     '<input class="newUserInput" type="email" name="email" maxlength="30" title="E-Mail" />'
                  + '</td>'
                  + '<td class="newUserTdClass">'
                  +     '<input class="newUserInput" type="text" name="lastName" maxlength="20" title="' + LOC.get( 'LOC_LAST_NAME' ) + '" />'
                  + '</td>'
                  + '<td class="newUserTdClass">'
                  ...
                  + '</td>'
                  + '<td class="newUserTdClass"><input id="newUserPhoneNumber" class="newUserInput" maxlength="14" type="text" name="phoneNumber" title="' + LOC.get( 'LOC_PHONE_NUMBER_LONG' ) + '" /></td>'
                  + '</tr></table></form>'
