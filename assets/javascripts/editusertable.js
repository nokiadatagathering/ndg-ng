var EditUserTable = (function() {
    ...
    function showTable(position, user) {
        ...
        tableHtml = '<form id="editUserForm" method="post" action="userManager/editUser"><table class="newUserTableClass">'
                  ...
                  + '<td class="newUserTdClass"><input class="newUserInput" type="text" name="username" maxlength="15" title="' + LOC.get( 'LOC_USERNAME' ) + '" value="' + user.username + '" readonly="readonly"/></td>'
                  + '<td class="newUserTdClass"><input class="newUserInput" type="text" name="firstName" maxlength="20" title="' + LOC.get( 'LOC_FIRST_NAME' ) + '" value="' + user.firstName + '" /></td>'
                  ...
                  + '<tr class="newUserTrClass">'
                  + '<td class="newUserTdClass">'
                  +     '<input class="newUserInput" type="email" name="email" maxlength="30" title="E-Mail" value="' + user.email + '" />'
                  + '</td>'
                  + '<td class="newUserTdClass">'
                  +     '<input class="newUserInput" type="text" name="lastName" maxlength="20" title="' + LOC.get( 'LOC_LAST_NAME' ) + '" value="' + user.lastName + '" />'
                  + '</td>'
                  + '<td class="newUserTdClass">'
                  ...
                  + '</td>'
                  + '<td class="newUserTdClass"><input id="newUserPhoneNumber" class="newUserInput" maxlength="14" type="text" name="phoneNumber" title="' + LOC.get( 'LOC_PHONE_NUMBER_LONG' ) + '" value="' + user.phoneNumber + '" /></td>'
                  + '</tr></table></form>'
